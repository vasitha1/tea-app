    ...
    <header className="sticky top-0 bg-white text-gray-800 shadow-md z-50">
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <Link href="/" className="text-2xl font-bold transition-colors duration-300">
          <span className="text-green-600/80 hover:text-green-700">Earth</span>
          <span className="text-gray-800">lixir</span>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/reviews" className="text-gray-700 hover:text-green-600 font-medium transition-colors duration-300">
            Reviews
          </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-gray-200">
          <div className="px-4 py-2 space-y-1">
            ...
            <Link href="/reviews" className="block px-3 py-2 text-gray-700 hover:text-green-600 hover:bg-gray-50 rounded-md font-medium transition-colors duration-300">
              Reviews
            </Link>
